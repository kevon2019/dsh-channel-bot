...
window.__ModuleLoader__.load({ id: "dsh-channel-bot", factory: (require) => {
  ...
  /* ---------- 设置不可用自诊断（v2.0.0-rc.6） ----------
   * [2026-09-10 实测] dsh >= 0.1.5 在「非本机托管」（域名 / 反向代理访问）时，
  ...
  function SettingsUnavailablePanel(props) {
    ...
    return React.createElement("div", { style: { padding: 12, fontSize: 13, lineHeight: 1.7,
        color: "var(--dsw-alias-text-secondary, #9aa4b2)", border: "1px dashed var(--dsw-alias-border-l2, #333)", borderRadius: 10 } },
      React.createElement("div", { style: { fontWeight: 600, marginBottom: 6, color: "var(--dsw-alias-text-primary, #e6e9ef)" } },
      ...
      React.createElement("div", { style: { marginTop: 10, fontSize: 12, color: "var(--dsw-alias-text-tertiary, #888)" } },
      ...
      React.createElement("div", { style: { marginTop: 10, display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } },
        ...
        React.createElement("button", { type: "button", style: btn, onClick: function () {
          var text = "dsh-channel-bot 设置不可用诊断\n地址: " + (hostDiag.origin || "?")
            ...
            + "\ndsh-core-isLoopback-判定在非本机托管时降级 settings（0.1.5 实测）";
