...
window.__ModuleLoader__.load({ id: "dsh-channel-bot", factory: (require) => {
  ...
  function SettingsGroup({ title, hint, children }) {
    return React.createElement("section", { style: { marginTop: 24, paddingTop: 16, borderTop: "1px solid var(--dsw-alias-border-secondary, rgba(127,127,127,0.18))" } },
      React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "var(--dsw-alias-text-primary, inherit)", lineHeight: 1.4 } }, title),
  ...
  function Field({ value, onCommit, placeholder, ariaLabel, type }) {
  ...
  function TextArea({ value, onCommit, placeholder, ariaLabel, rows }) {
    var [local, setLocal] = React.useState(value);
    var [focused, setFocused] = React.useState(false);
    React.useEffect(() => { setLocal(value); }, [value]);
  ...
  function ChannelBotSection() {
    ...
    return React.createElement("div", { style: { maxWidth: 640, padding: "14px 4px 24px" } },
      ...
      React.createElement(SettingsGroup, { title: "总开关", hint: "关闭后所有渠道停止响应。" },
        ...
        React.createElement(SectionField, { label: "命令前缀" },
          React.createElement(Field, { value: value.prefix || "/", onCommit: (v) => write(bound, "prefix", v || "/"), ariaLabel: "命令前缀" }))),
      React.createElement(SettingsGroup, { title: "Telegram", hint: "Bot Token 轮询收消息，无需公网。" },
        ...
        React.createElement(SectionField, { label: "Bot Token", hint: "@BotFather 创建机器人后获得的 token。" },
          React.createElement(Field, { value: (value.telegram && value.telegram.botToken) || "", onCommit: (v) => writeChannel(bound, value, "telegram", { botToken: v }), ariaLabel: "Telegram Bot Token" })),
        React.createElement(SectionField, { label: "允许的 Chat ID", hint: "逗号分隔，留空=所有会话。" },
          React.createElement(Field, { value: (value.telegram && value.telegram.allowedChatIds || []).join(", "), onCommit: (v) => writeChannel(bound, value, "telegram", { allowedChatIds: parseList(v) }), ariaLabel: "Telegram 允许的 Chat ID" })),
        ...
        React.createElement(SectionField, { label: "通知 Chat ID", hint: "通知推送目标，留空=取允许的 Chat ID 第一个。" },
          React.createElement(Field, { value: (value.telegram && value.telegram.notifyChatId) || "", onCommit: (v) => writeChannel(bound, value, "telegram", { notifyChatId: v }), ariaLabel: "Telegram 通知 Chat ID" }))),
      React.createElement(SettingsGroup, { title: "钉钉", hint: "群机器人 Webhook + 加签，入站回调走公网地址。" },
        ...
        React.createElement(SectionField, { label: "机器人 Webhook 地址" },
          React.createElement(Field, { value: (value.dingtalk && value.dingtalk.outWebhook) || "", onCommit: (v) => writeChannel(bound, value, "dingtalk", { outWebhook: v }), ariaLabel: "钉钉 Webhook" })),
        React.createElement(SectionField, { label: "加签密钥 (Secret)", hint: "入站回调地址: https://dsh.kevonchen.us/api/channel-bot/webhook/dingtalk" },
          React.createElement(Field, { value: (value.dingtalk && value.dingtalk.secret) || "", onCommit: (v) => writeChannel(bound, value, "dingtalk", { secret: v }), ariaLabel: "钉钉 Secret" }))),
      React.createElement(SettingsGroup, { title: "飞书", hint: "群机器人 Webhook + 加签，支持事件订阅回调。" },
        React.createElement(Row, { label: "启用" },
        ...
        React.createElement(SectionField, { label: "机器人 Webhook 地址" },
          React.createElement(Field, { value: (value.feishu && value.feishu.outWebhook) || "", onCommit: (v) => writeChannel(bound, value, "feishu", { outWebhook: v }), ariaLabel: "飞书 Webhook" })),
        React.createElement(SectionField, { label: "加签密钥 (Secret)", hint: "入站回调地址: https://dsh.kevonchen.us/api/channel-bot/webhook/feishu" },
          React.createElement(Field, { value: (value.feishu && value.feishu.secret) || "", onCommit: (v) => writeChannel(bound, value, "feishu", { secret: v }), ariaLabel: "飞书 Secret" }))),
      React.createElement(SettingsGroup, { title: "企业微信", hint: "群机器人 Webhook，v0.1 仅出站推送。" },
        React.createElement(Row, { label: "启用" },
        ...
        React.createElement(SectionField, { label: "机器人 Webhook 地址" },
          React.createElement(Field, { value: (value.wecom && value.wecom.outWebhook) || "", onCommit: (v) => writeChannel(bound, value, "wecom", { outWebhook: v }), ariaLabel: "企业微信 Webhook" }))),
      React.createElement(SettingsGroup, { title: "QQ (OneBot)", hint: "OneBot HTTP 上报 + 出站。" },
        React.createElement(Row, { label: "启用" },
        ...
        React.createElement(SectionField, { label: "OneBot HTTP 地址", hint: "入站上报地址: https://dsh.kevonchen.us/api/channel-bot/webhook/qq" },
          React.createElement(Field, { value: (value.qq && value.qq.onebotUrl) || "", onCommit: (v) => writeChannel(bound, value, "qq", { onebotUrl: v }), ariaLabel: "QQ OneBot 地址" })),
        React.createElement(SectionField, { label: "Access Token" },
          React.createElement(Field, { value: (value.qq && value.qq.accessToken) || "", onCommit: (v) => writeChannel(bound, value, "qq", { accessToken: v }), ariaLabel: "QQ Access Token" })),
        React.createElement(SectionField, { label: "群号", hint: "留空=私聊。" },
          React.createElement(Field, { value: (value.qq && value.qq.groupId) || "", onCommit: (v) => writeChannel(bound, value, "qq", { groupId: v }), ariaLabel: "QQ 群号" }))),
      React.createElement(SettingsGroup, { title: "微信（个人号 · 官方 iLink）", hint: "腾讯官方 iLink Bot API，扫码登录，长轮询收消息，无封号风险。" },
        React.createElement(Row, { label: "启用" },
        ...
        React.createElement(SectionField, { label: "Bot Token", hint: "扫码登录后自动写入；也可手动粘贴。" },
          React.createElement(Field, { value: (value.wechat && value.wechat.botToken) || "", onCommit: (v) => writeChannel(bound, value, "wechat", { botToken: v }), ariaLabel: "微信 Bot Token" })),
        React.createElement(SectionField, { label: "允许的用户 ID", hint: "逗号分隔的 xxx@im.wechat，留空=所有用户。" },
          React.createElement(Field, { value: (value.wechat && value.wechat.allowedUserIds || []).join(", "), onCommit: (v) => writeChannel(bound, value, "wechat", { allowedUserIds: parseList(v) }), ariaLabel: "微信允许的用户 ID" })),
        ...
        React.createElement(SectionField, { label: "通知用户 ID", hint: "通知推送目标，留空=取允许的用户 ID 第一个。" },
          React.createElement(Field, { value: (value.wechat && value.wechat.notifyUserId) || "", onCommit: (v) => writeChannel(bound, value, "wechat", { notifyUserId: v }), ariaLabel: "微信通知用户 ID" }))),
      ...
      React.createElement(SettingsGroup, { title: "远程对话", hint: "开启后，直接在 IM 里发普通消息（不带命令前缀）就会作为任务提交给 agent，回复原路发回该聊天。每个聊天绑定一个独立的 DSH 会话，重启后自动恢复。⚠️ 这等于把面板输入框开放给能给机器人发消息的人，务必先配好各渠道的「允许的 ID」白名单。" },
        ...
        React.createElement(SectionField, { label: "活跃窗口（分钟）", hint: "最近多少分钟内发过消息算「人在」，默认 10。" },
          React.createElement(Field, { type: "number", value: value.chat && value.chat.presenceWindowMin != null ? String(value.chat.presenceWindowMin) : "10", onCommit: (v) => { const n = Number(v); write(bound, "chat", Object.assign({}, value.chat || {}, { presenceWindowMin: Number.isFinite(n) ? n : 10 })); }, ariaLabel: "活跃窗口" })),
        React.createElement(SectionField, { label: "工作目录", hint: "新建会话的 cwd，留空=进程当前目录。" },
          React.createElement(Field, { value: (value.chat && value.chat.workspace) || "", onCommit: (v) => write(bound, "chat", Object.assign({}, value.chat || {}, { workspace: v })), ariaLabel: "工作目录" })),
        React.createElement(SectionField, { label: "模型 provider", hint: "留空=跟随面板默认模型。" },
          React.createElement(Field, { value: (value.chat && value.chat.provider) || "", onCommit: (v) => write(bound, "chat", Object.assign({}, value.chat || {}, { provider: v })), ariaLabel: "模型 provider" })),
        React.createElement(SectionField, { label: "模型 model", hint: "留空=跟随面板默认模型。" },
          React.createElement(Field, { value: (value.chat && value.chat.model) || "", onCommit: (v) => write(bound, "chat", Object.assign({}, value.chat || {}, { model: v })), ariaLabel: "模型 model" })),
        React.createElement(SectionField, { label: "最大会话数", hint: "已绑定聊天数量上限，默认 20。用 /end 解绑。" },
          React.createElement(Field, { type: "number", value: value.chat && value.chat.maxSessions != null ? String(value.chat.maxSessions) : "20", onCommit: (v) => { const n = Number(v); write(bound, "chat", Object.assign({}, value.chat || {}, { maxSessions: Number.isFinite(n) ? n : 20 })); }, ariaLabel: "最大会话数" }))),
      React.createElement(SettingsGroup, { title: "远程审批", hint: "高风险工具调用先推一张审批卡片到 IM，回复「/approve <id> yes|no」放行或拒绝。超时不响应=拒绝。关闭时审批仍走面板弹窗。" },
        ...
        React.createElement(SectionField, { label: "风险阈值", hint: "low / medium / high，达到或超过该级别才要审批，默认 medium。" },
          React.createElement(Field, { value: (value.approvals && value.approvals.minRisk) || "medium", onCommit: (v) => write(bound, "approvals", Object.assign({}, value.approvals || {}, { minRisk: String(v).trim().toLowerCase() })), ariaLabel: "风险阈值" })),
        React.createElement(SectionField, { label: "首次提醒超时（秒）", hint: "无人响应多久后推「任务已阻塞」提醒，默认 300。" },
          React.createElement(Field, { type: "number", value: value.approvals && value.approvals.timeoutSec != null ? String(value.approvals.timeoutSec) : "300", onCommit: (v) => { const n = Number(v); write(bound, "approvals", Object.assign({}, value.approvals || {}, { timeoutSec: Number.isFinite(n) ? n : 300 })); }, ariaLabel: "首次提醒超时" })),
        React.createElement(SectionField, { label: "最终拒绝超时（秒）", hint: "阻塞后再等多久判定为拒绝，默认 3600。" },
          React.createElement(Field, { type: "number", value: value.approvals && value.approvals.pendingMaxSec != null ? String(value.approvals.pendingMaxSec) : "3600", onCommit: (v) => { const n = Number(v); write(bound, "approvals", Object.assign({}, value.approvals || {}, { pendingMaxSec: Number.isFinite(n) ? n : 3600 })); }, ariaLabel: "最终拒绝超时" })),
        React.createElement(SectionField, { label: "自定义风险规则", hint: "一行一条：「风险级别 正则」，例如「high  terraform\\s+destroy」。先匹配自定义规则，再落内置规则。" },
          React.createElement(TextArea, { value: (value.approvals && value.approvals.riskRules) || "", onCommit: (v) => write(bound, "approvals", Object.assign({}, value.approvals || {}, { riskRules: v })), ariaLabel: "自定义风险规则" }))),
      ...
      React.createElement(SettingsGroup, { title: "通知事件", hint: "哪些情况触发推送，与桌面通知插件 (dsh-notification) 的通知类型一致。" },
        ...
        React.createElement(SectionField, { label: "余额阈值 (¥)", hint: "余额低于该值触发提醒，默认 5。" },
          React.createElement(Field, { type: "number", value: value.notifyEvents && value.notifyEvents.lowBalanceThreshold != null ? String(value.notifyEvents.lowBalanceThreshold) : "5", onCommit: (v) => { const n = Number(v); write(bound, "notifyEvents", Object.assign({}, value.notifyEvents || {}, { lowBalanceThreshold: Number.isFinite(n) ? n : 5 })); }, ariaLabel: "余额阈值" })),
        React.createElement(SectionField, { label: "关键词包含", hint: "一行一个或逗号分隔；至少命中一条才推送。支持 /正则/ 语法。" },
          React.createElement(TextArea, { value: (value.notifyEvents && value.notifyEvents.keywordInclude) || "", onCommit: (v) => write(bound, "notifyEvents", Object.assign({}, value.notifyEvents || {}, { keywordInclude: v })), ariaLabel: "关键词包含" })),
        React.createElement(SectionField, { label: "关键词排除", hint: "命中任一即不推送。同样支持 /正则/。" },
          React.createElement(TextArea, { value: (value.notifyEvents && value.notifyEvents.keywordExclude) || "", onCommit: (v) => write(bound, "notifyEvents", Object.assign({}, value.notifyEvents || {}, { keywordExclude: v })), ariaLabel: "关键词排除" })),
        React.createElement(SectionField, { label: "静默时段", hint: "例如「22:00-08:00」，逗号或换行分隔多段。时段内不推送（任务照常执行，只是不打扰）。" },
          React.createElement(Field, { value: (value.notifyEvents && value.notifyEvents.quietHours) || "", onCommit: (v) => write(bound, "notifyEvents", Object.assign({}, value.notifyEvents || {}, { quietHours: v })), ariaLabel: "静默时段" }))),
