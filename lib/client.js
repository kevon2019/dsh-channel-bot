  ...
  function ChannelBotSection() {
    ...
    return React.createElement(FoldContext.Provider, { value: foldValue },
      ...
      React.createElement(SettingsGroup, { title: "钉钉", hint: "群机器人 Webhook + 加签，入站回调走公网地址。", group: "cb-dd" },
        ...
        React.createElement(SectionField, { label: "加签密钥 (Secret)", hint: "入站回调地址: https://dsh.kevonchen.us/api/channel-bot/webhook/dingtalk" },
      ...
      React.createElement(SettingsGroup, { title: "飞书", hint: "群机器人 Webhook + 加签，支持事件订阅回调。", group: "cb-fs" },
        ...
        React.createElement(SectionField, { label: "加签密钥 (Secret)", hint: "入站回调地址: https://dsh.kevonchen.us/api/channel-bot/webhook/feishu" },
      ...
      React.createElement(SettingsGroup, { title: "QQ", hint: "方案一为 OneBot HTTP 上报 + 出站；方案二为 QQ 开放平台 v2（官方机器人）。", group: "cb-qq" },
        ...
        React.createElement("div", { "data-save-group": "cb-qq-s2" },
          ...
          React.createElement(CredHelp, { label: "QQ 开放平台", href: "https://q.qq.com", hrefLabel: "打开 QQ 开放平台", steps: ["登录 QQ 开放平台（q.qq.com）→ 应用管理 → 你的机器人", "到「开发基础设置」复制 AppID 与 AppSecret，填入上方两个输入框", "到机器人「事件订阅」配置 webhook 回调 = 方案一 OneBot 地址（https://dsh.kevonchen.us/api/channel-bot/webhook/qq）", "把服务器公网 IP 加进「IP 白名单」；单聊主动推送需申请「主动消息/单聊发送」权限"] }),
