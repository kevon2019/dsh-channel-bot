...
window.__ModuleLoader__.load({ id: "dsh-channel-bot", factory: (require) => {
  ...
  function SettingsGroup({ title, hint, children, group }) {
    ...
    return React.createElement("section", {
      ...
      React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } },
        React.createElement("div", { style: { flex: 1, fontSize: 13, fontWeight: 700, color: "var(--dsw-alias-text-primary, inherit)", lineHeight: 1.4, cursor: "pointer" }, onClick: () => setOpen(!open), title: "点击折叠/展开" },
          title),
        React.createElement("button", {
          type: "button", "aria-label": "折叠" + title, "aria-expanded": open,
      ...
      React.createElement("div", { style: { display: open ? "block" : "none" } },
  ...
  function ChannelBotSection() {
    ...
    return React.createElement("div", { style: { maxWidth: 640, padding: "14px 4px 24px" } },
      ...
      React.createElement(SettingsGroup, { title: "总开关", hint: "关闭后所有渠道停止响应。", group: "cb-sw" },
      ...
      React.createElement(SettingsGroup, { title: "企业微信", hint: "群机器人 Webhook；填 4 项应用消息参数则发给指定成员个人。", group: "cb-wx" },
        ...
        React.createElement(SectionField, { label: "方案二 · OpenClaw 长链接机器人（可选）", hint: "在企微管理后台「安全与合规 → 管理工具 → 智能机器人」创建 API 模式机器人并选「长连接」，会生成 Bot ID + Secret，填入后配合 OpenClaw 使用。此方案仅作配置记录/展示，实际企微对话由 OpenClaw 生态承接，本插件不直接收发企微智能机器人消息。" },
